...
class zaodu(object):
    ...
    def get_url(self):
        ...
        url_tmp = list(set(selector.xpath('//header/h2[@class="entry-title"]/a/@href')))
        """
    ...
    def get_news(self, url):
        ...
        try:
            ...
            news['labels'] = selector.xpath('//div[@class="single-cat"]/a/text()')[0]
...
if __name__ == '__main__':
    ...
    print(url_list)
    for url in url_list:
        print(spider.get_news(url)['title'])