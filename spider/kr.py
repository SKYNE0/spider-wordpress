...
class kr(object):
    ...
    def get_news(self, url):
        ...
        try:
            ...
            news['text'] = driver.find_element_by_xpath('//section[@class="textblock"]/p').text
            news['cover'] = driver.find_element_by_xpath('//span[@class="load-html-img loaded"]/img').get_attribute('src')
