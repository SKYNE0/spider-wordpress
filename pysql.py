...
def write(news):
    ...
    # 连接MySQL服务器
    conn = pymysql.connect(host = '***,***,***', port = 3306, user ='root', passwd = '***********', db ='wordpress', charset = 'utf8')
    cursor = conn.cursor()
    ...
    content = '\'' +  "![](" + news['cover'] +')'  + news['text'] + '\''
    title =  '\'' +  news['title'] + '\''
    excerpt = '\'' +  news["text"][1:150:1] + '...\''
...
if __name__ == '__main__':
    ...
    news = {'url': 'https://www.huxiu.com/article/227432.html', 'link': 'https://m.huxiu.com/article/227432.html', 'title': 'vfkhvbjkhbjkhgbhjmgkjh', 'text' : 'asdasdqwdqwdasdqwdqwdqwdqwd', 'author': '虎嗅网', 'labels': '金融地产', 'service': 'Article.AddArticle'}
    hu= huxiu()
